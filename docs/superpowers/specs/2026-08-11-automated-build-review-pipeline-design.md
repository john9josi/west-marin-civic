...
1. **Select** — read open GitHub issues, apply the same priority logic as the 2026-08-11 triage (P0 safety/data-accuracy first, then P1 verified-source safety features, then P2/P3), skip anything `blocked` or requiring human research, pick one ready item. If nothing qualifies, report "nothing ready" and stop — no forced busywork.
